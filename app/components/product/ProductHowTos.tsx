...
export const ProductHowTos: React.FC<ProductTodosProps> = ({ howToVideoUrl, howToStepList }) => {
    ...
    return (
        <>
            <div className={`desktop-component flex flex-row gap-6`}>
                {howToVideoUrl && (
            ...
            <div className={`mobile-component flex flex-col gap-6`}>
                {howToVideoUrl && (
                    <div className={`rounded-lg overflow-hidden shadow-[0_0_5px_rgba(0,0,0,0.3)]`}>
                        <ReactPlayer
                            url={howToVideoUrl}
                            width={"100%"}
                        />
