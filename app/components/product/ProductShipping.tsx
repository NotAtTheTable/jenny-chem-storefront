        ...
        <div className="flex gap-6">
            ...
            <div className="flex flex-grow gap-6">
                <div className="w-1/2">
                    ...
                    <p className="text-sm text-jc-dark-blue">*Delivery charges apply on hazchem products and orders over 100kg. Shipping is calculated at the checkout.</p>
                    <h3 className="text-jc-light-blue text-lg my-3">HAZCHEM DELIVERY</h3>
